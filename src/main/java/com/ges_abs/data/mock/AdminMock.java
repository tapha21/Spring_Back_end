    ...
    public void run(String... args) throws Exception {
        if (adminRepository.count() == 0) {
            List<Admin> admins = Arrays.asList(
                    new Admin("admin1", "pass1", "Attolode", "Victorin", "779952955", Role.ADMIN),
                    new Admin("admin2", "pass2", "Diop", "Papa Mbaye", "773646282", Role.ADMIN),
                    new Admin("admin3", "pass3", "Tchassakou", "Yao", "770000003", Role.ADMIN),
                    new Admin("admin4", "pass4", "Dossou", "Cyrille", "770000004", Role.ADMIN),
                    new Admin("admin5", "pass5", "Amegbo", "Julien", "770000005", Role.ADMIN)
            );
